...
public class FoodChoiceWindow extends Window {
	...
	private void initializeCheckOptionPanel(){
		...
		float bWidth=checkOptionPanel.getWidth()*.1f;
		float bHeight=checkOptionPanel.getHeight()*.08f;
		...
		nextConcernButton.setCenter(checkOptionPanel.getRightX()-bWidth*2, checkOptionPanel.getUpperY()+bHeight);
